...
// ⚙️ Setup your OpenAI client (or replace with Anthropic SDK if using Claude)
...
export const generateAIWorkflow = async (req, res) => {
  try {
    ...
    // 🧠 Ask the AI to design a structured workflow
...
3. All nodes must be custom nodes — do NOT use any "manual" or "manual trigger" types.
